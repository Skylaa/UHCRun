...
import eu.thog.uhcrun.gui.Gui;
import eu.thog.uhcrun.gui.GuiSelectTeam;
    ...
    public void onSignChange(SignChangeEvent event)
    {
        ...
        if (!game.getStatus().equals(Status.IN_GAME))
        {
            ...
            if (!name.isEmpty())
            {
                ...
                event.getPlayer().sendMessage(game.getTag() + " " + ChatColor.GREEN + "Le nom de votre équipe est désormais : " + team.getChatColor() + team.getTeamName());
                this.openGui(event.getPlayer(), new GuiSelectTeam());
            } else
            {
                event.getPlayer().sendMessage(game.getTag() + " " + ChatColor.RED + "Le nom de l'équipe ne peut être vide.");
                this.openGui(event.getPlayer(), new GuiSelectTeam());
            }
        }
    }
